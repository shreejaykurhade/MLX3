      ...
      <nav id="navbar">
        <div className="nav-inner">
          <a href="#" className="nav-logo">
            <span className="nav-logo-wrapper">
              <video className="nav-logo-video" autoPlay loop muted playsInline width="46" height="46">
                <source src="/monadslogo_transparent.webm?v=14" type="video/webm" />
              </video>
            </span>
          ...
          <div className="nav-actions">
            <a href="https://github.com/shreejaykurhade/MLX3" target="_blank" rel="noopener noreferrer" className="btn-ghost">
        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <p className="hero-desc">
              Describe your stack in plain English. An AI agent deploys it in under 60 seconds with SHA256-encrypted
              containers, per-provider EAS attestation, and x402 micropayments.
            </p>
            <div className="hero-ctas">
              <div className="flex items-center gap-4">
                {isConnected && !signedIn ? (
                  <button onClick={signIn} disabled={signingIn} className="btn-primary btn-lg">
                    {signingIn ? "Signing…" : "Sign In with Ethereum"}
                  </button>
                ) : !isConnected ? (
                  <ConnectButton.Custom>
                    {({ openConnectModal }) => (
                      <button onClick={openConnectModal} className="btn-primary btn-lg">
                        Connect Wallet
                      </button>
                    )}
                  </ConnectButton.Custom>
                ) : (
                  <a href="/dashboard" className="btn-primary btn-lg">Go to Dashboard</a>
                )}
                <a href="https://github.com/shreejaykurhade/MLX3" target="_blank" rel="noopener noreferrer" className="btn-outline btn-lg">
                  View on GitHub
                </a>
              </div>
            </div>
          ...
          <div className="hero-visual">
            <img src="/hero-visual.png?v=4" alt="MLX3 Trustless Architecture" className="hero-image" />
            <div className="hero-token-video-wrapper">
              <video className="hero-token-video" autoPlay loop muted playsInline>
                <source src="/vid_transparent.webm?v=5" type="video/webm" />
              </video>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="code-block">
            ...
            <pre className="code-content">
              <code>
                <span className="ln">1</span><span className="kw">import</span> mlx3
                {"\n"}
                <span className="ln">3</span><span className="cm">client</span> = mlx3.Client(<span className="str">api_key=</span><span className="str">"ck_live_..."</span>)
                {"\n"}
                <span className="ln">6</span><span className="comment"># Natural language deployment</span>
                {"\n"}
                <span className="ln">7</span><span className="cm">job</span> = <span className="kw">await</span> client.deploy(<span className="str">"""</span>
                {"\n"}
                ...
                {"\n"}
                <span className="ln">10</span><span className="str">"""</span>)
                {"\n"}
                ...
                {"\n"}
                <span className="ln">23</span><span className="kw">print</span>(attestation.merkle_root)   <span className="comment"># recompute locally</span>
              </code>
            </pre>
          </div>
          ...
          <div className="stat-grid">
            ...
            <div className="stat-card">
              ...
              <div className="stat-desc">Filesystem encrypted with your key, generated in your browser, never sent to the server</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="section-dark">
        <div className="container">
          ...
          <div className="pillars-grid">
            <div className="pillar-card">
              ...
              <p className="pillar-desc">
                Every container runs with SHA256 filesystem encryption. The key is derived from your keypair, generated in-browser, never sent to the server. Even with root access on the host machine, the operator cannot read your data.
              </p>
            </div>
            <div className="pillar-card">
          ...
          <div className="pillar-ctas">
            ...
            <a href="https://github.com/shreejaykurhade/MLX3" target="_blank" rel="noopener noreferrer" className="btn-ghost-dark">
              Read Architecture
            </a>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="table-wrapper">
            <table className="compare-table">
              ...
              <tbody>
                <tr>
                  <td className="row-label"><strong>Agentic Deployment</strong><br /><small>Natural language to running infrastructure</small></td>
                ...
                <tr>
                  <td className="row-label"><strong>Confidential Compute</strong><br /><small>Operator cannot read your data</small></td>
                  <td className="cell-no">No</td>
                  <td className="cell-no">No</td>
                ...
                <tr>
                  <td className="row-label"><strong>On-Chain Attestation</strong><br /><small>Cryptographic proof of what the agent ran</small></td>
                  <td className="cell-no">No</td>
                  <td className="cell-no">No</td>
                  <td className="cell-no">No</td>
                  <td className="cell-partial">Partial</td>
                ...
                <tr>
                  <td className="row-label"><strong>Open Provider Network</strong><br /><small>Anyone can join as a compute provider</small></td>
                  <td className="cell-no">No</td>
                  <td className="cell-no">No</td>
                  <td className="cell-yes">Yes</td>
                  <td className="cell-partial">Partial</td>
        ...
        <div className="container">
          <div className="faq-layout">
            <div className="faq-sidebar">
              ...
              <p className="faq-link-text">More questions? <a href="https://github.com/shreejaykurhade/MLX3" target="_blank" rel="noopener noreferrer">Open an issue on GitHub</a>.</p>
            </div>
            <div className="faq-list">
              <div className="faq-item">
                ...
                <div className="faq-answer">
                  ...
                  deploys it in under 60 seconds using SHA256-encrypted containers with per-provider on-chain EAS
                  attestation and x402 micropayments — so you can verify everything that ran.
                </div>
              </div>
              <div className="faq-item">
                <button className="faq-btn" onClick={(e) => (window as any).toggleFaq?.(e.currentTarget)}>
              ...
              <div className="faq-item">
                ...
                <div className="faq-answer">
                  Your keypair is generated in your browser and never sent to our servers. Your container's SHA256
                  encryption key is derived from that keypair. Even with root access on the physical host, the operator sees only
                  encrypted bytes.
                </div>
              </div>
              <div className="faq-item">
      ...
      <section className="section-dark cta-section">
        <div className="container text-center">
          ...
          <div className="cta-buttons">
            {isConnected && !signedIn ? (
              <button onClick={signIn} disabled={signingIn} className="btn-primary btn-xl">
                {signingIn ? "Signing…" : "Sign In with Ethereum"}
              </button>
            ) : !isConnected ? (
              <ConnectButton.Custom>
                {({ openConnectModal }) => (
                  <button onClick={openConnectModal} className="btn-primary btn-xl">
                    Connect Wallet
                  </button>
                )}
              </ConnectButton.Custom>
            ) : (
              <a href="/dashboard" className="btn-primary btn-xl">Go to Dashboard →</a>
            )}
            <a href="https://github.com/shreejaykurhade/MLX3" target="_blank" rel="noopener noreferrer" className="btn-ghost-dark btn-xl">
              View GitHub
            </a>
          </div>
        </div>
      ...
      <footer className="footer">
        <div className="container footer-inner">
          ...
          <div className="footer-links">
            ...
            <a href="#faq">FAQ</a>
            <a href="https://github.com/shreejaykurhade/MLX3" target="_blank" rel="noopener noreferrer">GitHub</a>
          </div>
          <p className="footer-copy">© 2025 MLX3. Live on Base Sepolia.</p>
        </div>
      </footer>

      <Script src="/main.js?v=10" strategy="afterInteractive" />
    </>
  );
}
